...
import logo from "../../assets/leetcode_slidingwindow.png";
import { notesData, coordsData } from "../../constant/leetcode_slidingwindow";
import "./common.css";

export default function Leetcode_Slidingwindow() {
